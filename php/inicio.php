...
<body>
    ...
    <ul class="slides">
      <li>
        ...
        <div class="caption center-align">
          ...
          <h5 class="light grey-text text-lighten-3">samuel es mk</h5>
        </div>
      </li>
      <li>
            ...
            <div class="col m4">
              <div class="card  blue lighten-1  ">
                <div class="card-image">
                  ...
                  <span class="card-title whithe-text">TERCER AÑO</span>
                </div>
                <div class="card-content">
                  <p>Aqui podras ver el contenido del curso</p>
                </div>
                <div class="card-action center-align">
                  <form action="index_2.php" method="POST">
                    ...
                    <a  class="btn waves-effect waves-light white black-text"  href="semestre.php">ver contenido </a><!--muestra-->
                  </form>
                </div>
              </div>
            </div>
            ...
            <div class="col m4">
              <div class="card  blue lighten-1">
                <div class="card-image">
                  ...
                  <span class="card-title white-text">CUARTO AÑO</span>
                </div>
                  <div class="card-content">
                  <p>Aqui podras ver el contenido del curso</p>
                  </div>
             ...
             <div class="col m4">
              <div class="card  blue lighten-1">
                <div class="card-image">
                  <img class="section" src="https://cdn.pixabay.com/photo/2013/07/18/20/26/boat-164989_960_720.jpg">
                  <span class="card-title white-text">QUINTO AÑO</span>
                </div>
                  <div class="card-content">
                  <p>Aqui podras ver el contenido del curso</p>
                  </div>
  ...
  <!-- publicidad -->
  <div class="col m2">
    <h5>Este espacio esta reservado para poner publicidad externas de la academia!!</h5>
    </div>
  </div>
