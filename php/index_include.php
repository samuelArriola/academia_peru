            ...
            <div class="col m6">
              <div class="card  blue lighten-1  ">
                <div class="card-image">
                  ...
                  <span class="card-title whithe-text">PRIMARIA</span>
                </div>
                <div class="card-content">
                  <p>Aqui podrás ver las ofertas y todo el contenido de primaria.</p>
                </div>
            ...
            <div class="col m6">
              <div class="card  blue lighten-1">
                <div class="card-image">
                  ...
                  <span class="card-title white-text">SECUNDARIA</span>
                </div>
                  <div class="card-content">
                  <p>Aqui podrás ver las ofertas y todo el contenido de secundaria.</p>
                  </div>
                  <div class="card-action center-align">
                    <form action="index_2.php" method="POST">
                        <input type="hidden" name="materia" value="ESPAÑOL">
